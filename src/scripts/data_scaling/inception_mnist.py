...
trainer.fit(model, subset_dl, ckpt_path=ckpt_path)
...
inference_model = InceptionV3.load_from_checkpoint(script_name + '_epochs=' + str(argv[1]) + '_k=' + str(argv[2]) + ".pt", map_location=device)
