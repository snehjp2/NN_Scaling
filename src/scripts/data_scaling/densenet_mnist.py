...
class DenseNet(pl.LightningModule):
  def __init__(self):
    ...
    self.model.fc = Linear(in_features=1024, out_features=10)
...
inference_model = DenseNet.load_from_checkpoint(script_name + '_epochs=' + str(argv[1]) + '_k=' + str(argv[2]) + ".pt", map_location=device)
